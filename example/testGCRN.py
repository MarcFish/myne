...
model = GCRN(book.g.node_size, arg.embed_size, book.label_size, mode=1, stack=1)
...
embedding_matrix = np.reshape(model.embedding.numpy(), (book.g.node_size, -1))
embed_visual(embedding_matrix, book.label_array, filename="../results/img/book_gcrn1.png")
