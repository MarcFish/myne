...
gcn.fit([X, A], Y, batch_size=cora.g.node_size, epochs=arg.epoch, shuffle=False)

embedding_matrix = gcn_([X, A]).numpy()
embed_visual(embedding_matrix, cora.label_matrix, filename="../results/img/cora_gcn.png")
